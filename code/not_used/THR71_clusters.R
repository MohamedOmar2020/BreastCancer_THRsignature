...
THR_71 <- c(THR_50_fil, 'B3GNT5', 'LOXL2', 'BMP1', 'SIDT1', 'DTX2', 'PAIP2', 'GFOD1', 'PABPC1L2B', 'TP53TG1', 'GPD1L', 'SAMD9', 'TNFAIP8', 'LMNB2', 'ZNF764', 'ICA1', 'KLHL25', 'OAZ3', 'LINC00674', 'PML', 'REEP5', 'ISCU')

summary(THR_71 %in% rownames(Expr_metabric_refAll))
THR_71[!(THR_71 %in% rownames(Expr_metabric_refAll))]

THR_71_fil <- THR_71[THR_71 %in% rownames(Expr_metabric_refAll)]

#############################################################################################
#############################################################################################
## heatmap (THR 50)
Expr_metabric_refAll_heatmap <- Expr_metabric_refAll[THR_71_fil, ] 
...
tiff('./figures/logreg/THR71_clusters/THR71_heatmap_metabric.tiff', width=3000, height=2000, res = 300)
...
ann_colors$`THR clusters` <- c("#66A61E", "#1B9E77" ,"#7570B3", "#D95F02", "#E7298A") 
levels(AnnAll_metabric$`THR clusters`) <- c('E1', 'E2', 'T1', 'E3', 'E4')
names(ann_colors$`THR clusters`) <- levels(AnnAll_metabric$`THR clusters`)

# heatmap with clinical annotation
tiff('./figures/logreg/THR71_clusters/THR71_heatmap_metabric_clusters.tiff', width=3000, height=2000, res = 300)
pheatmap(Expr_metabric_refAll_heatmap, 
         scale = "none",
         #color = rev(heat.colors(20)),
         color =ColPal,
...
levels(survival_metabric$`THR clusters`) <- c('E1', 'E2', 'T1', 'E3', 'E4')
...
pdf("./figures/logreg/THR71_clusters/metabric_os_5clusters.pdf", width = 10, height = 8, onefile = F)
...
# plot RFS
pdf("./figures/logreg/THR71_clusters/metabric_rfs_5clusters.pdf", width = 10, height = 8, onefile = F)
