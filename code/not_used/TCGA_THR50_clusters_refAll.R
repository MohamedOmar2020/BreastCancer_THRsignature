...
tiff('./figures/tcga/THR50_original_clusters/THR50_heatmap_tcga_clusters_refAll.tiff', width=3000, height=2000, res = 300)
...
tiff('./figures/tcga/THR50_original_clusters/THR50_heatmap_tcga_clusters_E_refAll.tiff', width=3000, height=2000, res = 300)
pheatmap(Expr_tcga_refAll_heatmap, 
         scale = "none",
         #color = rev(heat.colors(20)),
         color =ColPal,
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_5clusters_refAll.pdf", width = 10, height = 8, onefile = F)
...
# plot RFS
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_5clusters_refAll.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_ERstatus_refAll.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_ERstatus_refAll.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_pam50_refAll.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_pam50_refAll.pdf", width = 10, height = 8, onefile = F)
