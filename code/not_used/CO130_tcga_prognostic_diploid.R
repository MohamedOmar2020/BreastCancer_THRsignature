...
########
# by quartiles
tiff("./figures/CO130_tcga/CO130_tcga_os_quartiles_10yrs_refDiploid.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/CO130_tcga/CO130_tcga_os_quartiles_merged_10yrs_refDiploid.tiff", width = 3000, height = 3000, res = 300)
