...
CoxData_tcga <- CoxData_tcga %>%
  mutate(tcga_prob_CO110_quartiles = ntile(Train_prob_CO110, 4), 
         ...
         tcga_prob_CO110_tertiles = ntile(Train_prob_CO110, 3)
  )
...
# OS
## tcga all genes
Fit_sig_tcga_os <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ Train_predClasses_CO110, data = CoxData_tcga)


## by quartiles
Fit_sig_tcga_os_quartiles <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quartiles, data = CoxData_tcga)

## by quintiles
Fit_sig_tcga_os_quintiles <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quintiles, data = CoxData_tcga)

## by tertiles
Fit_sig_tcga_os_tertiles <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_tertiles, data = CoxData_tcga)

#############
# DFS
## tcga all genes
Fit_sig_tcga_DFS <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ Train_predClasses_CO110, data = CoxData_tcga)

## by quartiles
Fit_sig_tcga_DFS_quartiles <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quartiles, data = CoxData_tcga)

## by quintiles
Fit_sig_tcga_DFS_quintiles <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quintiles, data = CoxData_tcga)

## by tertiles
Fit_sig_tcga_DFS_tertiles <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_tertiles, data = CoxData_tcga)
...
# os: all
Fit_sig_tcga_os_PAM <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ Train_predClasses_CO110 + Subtype, data = CoxData_tcga_PAM)

# os: quartiles: all
Fit_sig_tcga_os_quartiles_PAM <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quartiles + Subtype, data = CoxData_tcga_PAM)

# os: quintiles: all
Fit_sig_tcga_os_quintiles_PAM <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quintiles + Subtype, data = CoxData_tcga_PAM)

# os: quartiles: Q1 vs Q4
Fit_sig_tcga_os_Q1vsQ4_PAM <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quartiles + Subtype, data = CoxData_tcga_PAM_Q1vsQ4)

# os: quintiles: Q1 vs Q5
Fit_sig_tcga_os_Q1vsQ5_PAM <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quintiles + Subtype, data = CoxData_tcga_PAM_Q1vsQ5)

##########
# DFS: all
Fit_sig_tcga_dfs_PAM <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ Train_predClasses_CO110 + Subtype, data = CoxData_tcga_PAM)

# rfs: quartiles: all
Fit_sig_tcga_dfs_quartiles_PAM <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quartiles + Subtype, data = CoxData_tcga_PAM)

# rfs: quintiles: all
Fit_sig_tcga_dfs_quintiles_PAM <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quintiles + Subtype, data = CoxData_tcga_PAM)

# rfs: quartiles: Q1 vs Q4
Fit_sig_tcga_dfs_Q1vsQ4_PAM <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quartiles + Subtype, data = CoxData_tcga_PAM_Q1vsQ4)

# rfs: quintiles: Q1 vs Q5
Fit_sig_tcga_dfs_Q1vsQ5_PAM <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quintiles + Subtype, data = CoxData_tcga_PAM_Q1vsQ5)
...
# os: all
Fit_sig_tcga_os_ER <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ Train_predClasses_CO110 + ER.Status.By.IHC, data = CoxData_tcga)

# os: quartiles: all
Fit_sig_tcga_os_quartiles_ER <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quartiles + ER.Status.By.IHC, data = CoxData_tcga)

# os: quintiles: all
Fit_sig_tcga_os_quintiles_ER <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quintiles + ER.Status.By.IHC, data = CoxData_tcga)

# os: quartiles: Q1 vs Q4
Fit_sig_tcga_os_Q1vsQ4_ER <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quartiles + ER.Status.By.IHC, data = CoxData_tcga_Q1vsQ4)

# os: quintiles: Q1 vs Q5
Fit_sig_tcga_os_Q1vsQ5_ER <- survfit(Surv(Overall.Survival..Months., Overall.Survival.Status) ~ tcga_prob_CO110_quintiles + ER.Status.By.IHC, data = CoxData_tcga_Q1vsQ5)

##############
# dfs: all
Fit_sig_tcga_dfs_ER <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ Train_predClasses_CO110 + ER.Status.By.IHC, data = CoxData_tcga)

# rfs: quartiles: all
Fit_sig_tcga_dfs_quartiles_ER <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quartiles + ER.Status.By.IHC, data = CoxData_tcga)

# rfs: quintiles: all
Fit_sig_tcga_dfs_quintiles_ER <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quintiles + ER.Status.By.IHC, data = CoxData_tcga)

# rfs: quartiles: Q1 vs Q4
Fit_sig_tcga_dfs_Q1vsQ4_ER <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quartiles + ER.Status.By.IHC, data = CoxData_tcga_Q1vsQ4)

# rfs: quintiles: Q1 vs Q5
Fit_sig_tcga_dfs_Q1vsQ5_ER <- survfit(Surv(Disease.Free..Months., Disease.Free.Status) ~ tcga_prob_CO110_quintiles + ER.Status.By.IHC, data = CoxData_tcga_Q1vsQ5)
...
tiff("./figures/CO110_tcga/CO110_tcga_os_all.tiff", width = 3000, height = 3000, res = 300)
...
########
# by quartiles
tiff("./figures/CO110_tcga/CO110_tcga_os_quartiles.tiff", width = 3000, height = 3000, res = 300)
...
#############
# by quintiles
tiff("./figures/CO110_tcga/CO110_tcga_os_quintiles.tiff", width = 3000, height = 3000, res = 300)
...
#############
# by tertiles
tiff("./figures/CO110_tcga/CO110_tcga_os_tertiles.tiff", width = 3000, height = 3000, res = 300)
...
# plot RFS
######################################
tiff("./figures/CO110_tcga/CO110_tcga_DFS_allpairs.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/CO110_tcga/CO110_tcga_DFS_quartiles.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/CO110_tcga/CO110_tcga_DFS_quintiles.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/CO110_tcga/CO110_tcga_DFS_tertiles.tiff", width = 3000, height = 3000, res = 300)
...
pdf("./figures/CO110_prognostic/tcga/CO110_tcga_os_PAM50.pdf", width = 8, height = 8, onefile = F)
