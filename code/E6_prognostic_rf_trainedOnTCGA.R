...
E6_rf_model <- train(os_event ~ .,
                  data=Data_tcga_ERposHER2neg[, c("os_event", E6_fil)],
                  method="rf",
...
save(E6_rf_model, file = 'objs/E6_rf_model.rda')
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_rf_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_rf_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_rf_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_rf_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
