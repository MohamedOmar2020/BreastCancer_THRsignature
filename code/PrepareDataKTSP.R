...
#Expr_metabric_refNorm <- read.delim("./data/brca_metabric_cbioportal/data_mrna_agilent_microarray_zscores_ref_all_samples.txt")
...
all(rownames(Pheno_tcga) == colnames(Expr_tcga_refNorm))

Expr_tcga_refAll <- as.matrix(Expr_tcga_refAll)
Expr_tcga_refDip <- as.matrix(Expr_tcga_refDip)
Expr_tcga_refNorm <- as.matrix(Expr_tcga_refNorm)
...
####################################################################################
# save
save(Expr_metabric_refAll, Expr_metabric_refDip, Expr_tcga_refAll, Expr_tcga_refDip, Expr_tcga_refNorm, group_metabric, group_tcga, Pheno_metabric, Pheno_tcga, file = './objs/forKTSP.rda')
