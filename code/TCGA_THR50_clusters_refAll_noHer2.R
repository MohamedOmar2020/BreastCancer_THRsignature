...
THR_50_fil <- THR_50[THR_50 %in% rownames(Expr_tcga_refAll)]
...
#############################################################################################
## heatmap (THR 50)
Expr_tcga_refAll_heatmap <- Expr_tcga_refAll[THR_50_fil, ] 
...
# colors
ann_colors = list()
ann_colors$Pam50_subtypes <- colorRampPalette(colors = rev(brewer.pal(8,"RdYlBu")))(5)
...
tiff('./figures/tcga/THR50_original_clusters/THR50_heatmap_tcga_clusters_refAll_noHer2.tiff', width=3000, height=2000, res = 300)
...
tiff('./figures/tcga/THR50_original_clusters/THR50_heatmap_tcga_clusters_E_refAll_noHer2.tiff', width=3000, height=2000, res = 300)
pheatmap(Expr_tcga_refAll_heatmap, 
         scale = "none",
         #color = rev(heat.colors(20)),
         color =ColPal,
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_5clusters_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
ggsurvplot(Fit_tcga_os,
           ...
           risk.table.y.text = FALSE, title = 'THR50 clusters and OS in TCGA (no HER2)')
dev.off()


# plot RFS
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_5clusters_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
ggsurvplot(Fit_tcga_DFS,
           ...
           ggtheme = theme_survminer(base_size = 18, font.x = c(18, 'bold.italic', 'black'), font.y = c(18, 'bold.italic', 'black'), font.tickslab = c(18, 'plain', 'black'), font.legend = c(18, 'bold', 'black')),
           risk.table.y.text.col = FALSE,
           risk.table.y.text = FALSE, title = 'THR50 clusters and DFS in TCGA (no HER2)')
dev.off()
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_ERstatus_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_ERstatus_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
...
pdf("./figures/tcga/THR50_original_clusters/tcga_os_pam50_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
ggsurvplot(Fit_tcga_os_Pam50,
           risk.table = FALSE,
           pval = TRUE,
           #palette = cluster_colors,
           #xlim = c(0,120),
           legend.labs = c('Unknown', 'Basal', 'Luminal A', 'Luminal B', 'normal-like'),
...
pdf("./figures/tcga/THR50_original_clusters/tcga_dfs_pam50_refAll_noHer2.pdf", width = 10, height = 8, onefile = F)
