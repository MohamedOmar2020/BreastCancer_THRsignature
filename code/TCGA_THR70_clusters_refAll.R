...
THR_70_fil <- THR_70[THR_70 %in% rownames(Expr_tcga_refAll)]
...
#############################################################################################
## heatmap (THR 50)
Expr_tcga_refAll_heatmap <- Expr_tcga_refAll[THR_70_fil, ] 
...
tiff('./figures/tcga/THR70_original_clusters/THR70_heatmap_tcga_clusters_refAll.tiff', width=3000, height=2000, res = 300)
...
tiff('./figures/tcga/THR70_original_clusters/THR70_heatmap_tcga_clusters_E_refAll.tiff', width=3000, height=2500, res = 300)
pheatmap(Expr_tcga_refAll_heatmap, 
         scale = "none",
         #color = rev(heat.colors(20)),
         color =ColPal,
...
pdf("./figures/tcga/THR70_original_clusters/tcga_os_5clusters_refAll.pdf", width = 10, height = 8, onefile = F)
...
# plot RFS
pdf("./figures/tcga/THR70_original_clusters/tcga_dfs_5clusters_refAll.pdf", width = 10, height = 8, onefile = F)
