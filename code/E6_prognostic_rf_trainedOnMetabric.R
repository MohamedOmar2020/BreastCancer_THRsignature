...
# Train the model
E6_rf_model <- train(os_event ~ .,
                     data=Data_metabric_ERposHER2neg[, c("os_event", E6_fil)],
                     method="rf",
...
save(E6_rf_model, file = 'objs/E6_rf_model_TrainedOnMetabric.rda')
...
######################
# Training set: Metabric
######################

metabric_prob <- E6_rf_model %>% predict(Data_metabric_ERposHER2neg, type = "prob")

### Threshold
thr <- coords(roc(Data_metabric_ERposHER2neg$os_event, metabric_prob[,2], levels = c("low.risk", "high.risk"), direction = "<"), "best")["threshold"]
thr

### ROC Curve
roc_metabric <- roc(Data_metabric_ERposHER2neg$os_event, metabric_prob[,2], plot = F, print.thres=thr$threshold, print.auc=TRUE, print.auc.col="black", ci = T, levels = c("low.risk", "high.risk"), direction = "<", col="blue", lwd=2, grid=TRUE)
roc_metabric
...
tcga_prob <- E6_rf_model %>% predict(Data_tcga_ERposHER2neg , type = "prob")
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_rfTrainedOnMetabric_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_rfTrainedOnMetabric_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_rfTrainedOnMetabric_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
# COX
metabric_cox_os_two_classes <- coxph(metabric_os_surv_obj ~ metabric_classes, data = survival_metabric)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_rfTrainedOnMetabric_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
# COX
metabric_cox_rfs_two_classes <- coxph(metabric_rfs_surv_obj ~ metabric_classes, data = survival_metabric)
