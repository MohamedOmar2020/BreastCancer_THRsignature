...
E6_svm_model <- train(as.formula((paste("os_event ~", paste(E6_fil, collapse = "+")))), data=Data_metabric_ERposHER2neg, method="svmPoly", trControl=trainControl(method = "none", classProbs = TRUE, summaryFunction = twoClassSummary), tuneGrid = Grid, metric = "ROC")
E6_svm_model

save(E6_svm_model, file = 'objs/E6_svm_model_trainedOnMetabric.rda')
...
metabric_prob <- E6_svm_model %>% predict(Data_metabric_ERposHER2neg, type = "prob")
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_svmTrainedOnMetabric_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_tcga_prognostic/E6_tcga_svmTrainedOnMetabric_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_svmTrainedOnMetabric_os_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
...
tiff("./figures/E6_metabric_prognostic/E6_metabric_svmTrainedOnMetabric_rfs_two_predClasses.tiff", width = 3000, height = 3000, res = 300)
