...
ktsp_metabric <- SWAP.Train.KTSP(
  Expr_metabric, group_metabric, krange=6, disjoint = T, 
...
Splot_metabric_os <- arrange_ggsurvplots(plot_list_metabric_os, title = "Survival plots using the 6 pairs individually", ncol = 2, nrow = 3)
ggsave("./figures/6TSPs_Metabric_os.pdf", Splot_metabric_os, width = 40, height = 30, units = "cm")
...
ggsurvplot(Fit_sig_metabric,
           ...
           risk.table.y.text = FALSE, title = '6-TSPs and METABRIC OS')
dev.off()
...
Splot_tcga_os <- arrange_ggsurvplots(plot_list_tcga_os, title = "Overall survival in the TCGA using the 6 pairs individually", ncol = 2, nrow = 3)
ggsave("./figures/6TSPs_tcga_os.pdf", Splot_tcga_os, width = 40, height = 30, units = "cm")
...
ggsurvplot(Fit_sig_TCGA_os,
           ...
           ggtheme = theme_minimal(),
           risk.table.y.text.col = FALSE,
           risk.table.y.text = FALSE, title = '6-TSPs and TCGA OS')
dev.off()
...
Splot_tcga_pfs <- arrange_ggsurvplots(plot_list_tcga_pfs, title = "Progression free survival in the TCGA using the 6 pairs individually", ncol = 2, nrow = 3)
ggsave("./figures/6TSPs_tcga_pfs.pdf", Splot_tcga_pfs, width = 40, height = 30, units = "cm")
...
ggsurvplot(Fit_sig_TCGA_pfs,
           ...
           ggtheme = theme_minimal(),
           risk.table.y.text.col = FALSE,
           risk.table.y.text = FALSE, title = '6-TSPs and TCGA PFS')
dev.off()
