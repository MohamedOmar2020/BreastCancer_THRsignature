...
OS_c3 <- as.factor(cluster3_pheno$Overall.Survival.Status)
Data_c3 <- as.data.frame(cbind(t(cluster3_expr), OS_c3))
Data_c3$OS_c3 <- as.factor(Data_c3$OS_c3)
levels(Data_c3$OS_c3) <- c('0', '1')

#####################################
# the model
THR50_model_c3 <- glm(as.formula((paste("OS_c3 ~", paste(THR_50_fil, collapse = "+")))), data = Data_c3, family = "binomial")
...
### Threshold
thr_THR50_c3 <- coords(roc(OS_c3, Train_prob_THR50_c3, levels = c("0", "1"), direction = "<"), "best")["threshold"]
thr_THR50_c3

### ROC Curve
ROCTrain_THR50_c3 <- roc(OS_c3, Train_prob_THR50_c3, plot = F, print.thres=thr_THR50_c3$threshold, print.auc=TRUE, print.auc.col="black", ci = T, levels = c("0", "1"), direction = "<", col="blue", lwd=2, grid=TRUE)
ROCTrain_THR50_c3
...
# plot OS
tiff("./figures/c3_logReg_OS/THR50_metabric_os_c3.tiff", width = 3000, height = 3000, res = 300)
...
######################################
# plot RFS
tiff("./figures/c3_logReg_OS/THR50_metabric_rfs_c3.tiff", width = 3000, height = 3000, res = 300)
...
pdf("./figures/c3_logReg_OS/metabric_os_5clusters_newC3.pdf", width = 10, height = 8, onefile = F)
...
## RFS: 
pdf("./figures/c3_logReg_OS/metabric_rfs_5clusters_newC3_10yrs.pdf", width = 10, height = 8, onefile = F)
...
tiff('./figures/c3_logReg_OS/THR50_heatmap_metabric_clusters_newC3.tiff', width=3000, height=2000, res = 300)
